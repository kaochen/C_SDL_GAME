...
int
goalLeft (Square grid[][getMax_Y_Blocks ()])
{
...
int
nbr_of_goals (Square grid[][getMax_Y_Blocks ()])
{
...
int
displayProgress (Square grid[][getMax_Y_Blocks ()], SDL_Surface * screen,
		 Sprites tableSurface[NBR_OF_IMAGES])
{
...
/* Victory or not ? */
int
levelFinished (Square grid[][getMax_Y_Blocks ()])
{
  /* get info */
  int i = goalLeft (grid);
